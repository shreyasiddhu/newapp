  ...
  useEffect(() => {
    if (mode === "update") {
      ...
      fetchData(config, { showSuccessToast: false }).then((data) => {
        ...
        console.log(typeof data.task.dueDate);
        setFormData({ description: data.task.description,duedate:data.task.dueDate.split('T')[0], taskTitle:data.task.title});
      });
    }
          ...
          {loading ? (
            ...
            <>
              ...
              <div className="mb-4">
                ...
                <input type="text" name='taskTitle' id='taskTitle' value={formData.taskTitle} onChange={handleChange}/>
              </div>
              <div className="mb-4">
